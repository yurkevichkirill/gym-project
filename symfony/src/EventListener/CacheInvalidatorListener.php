    ...
    public function onFlush(OnFlushEventArgs $eventArgs): void
    {
        ...
        foreach (array_merge(
            ...
            match(true) {
                ...
                $entity instanceof Booking => $this->gymCache->invalidateTags([
                    "bookings_list_" . $entity->getClient()->getId(),
                    "bookings_list_all"
                ]),
                ...
                $entity instanceof Payment => $this->gymCache->invalidateTags([
                    'payments_list_' . $entity->getClient()->getId(),
                    'payments_list_trainer_' . $entity->getTrainer()?->getId(),
                    "payments_list_all",
                ]),
                ...
                $entity instanceof Training => [
                    $this->gymCache->invalidateTags([
                        'trainer_worktimes_list_' . $entity->getTrainerWorkTime()->getTrainer()->getId(),
                        "trainings_list_" . $entity->getTrainerWorkTime()->getTrainer()->getId(),
                        "trainings_list_all",
                    ]),
                ],
